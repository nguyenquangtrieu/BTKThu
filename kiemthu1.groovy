...
WebUI.click(findTestObject('Page_Hc liu - Sch Mm/a_TestClass'))

WebUI.delay(2)

WebUI.click(findTestObject('Page_Hc liu - Sch Mm/li_Thng bo_main-icon mr-3'))

WebUI.delay(2)

WebUI.click(findTestObject('Page_Hc liu - Sch Mm/div_M tham gia lp hc'))

WebUI.delay(2)

WebUI.click(findTestObject('Page_Hc liu - Sch Mm/button_i m'))
